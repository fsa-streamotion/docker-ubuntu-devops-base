...
export JX_VERSION=v2.0.800
export EKSCTL_VERSION=latest_release
...
#     cp oktashell assumerole requirements.txt /opt/okta-utils && \
#     pip3 install --no-cache-dir -r /opt/okta-utils/requirements.txt && \
#     pip3 install sceptre-aws-resolver

# #Install Hub
# curl -L https://github.com/github/hub/releases/download/v2.12.1/hub-linux-amd64-2.12.1.tgz  -o /tmp/hub.tar.gz && \
...
# echo "source <(jx completion bash)" >> ~/.bashrc
...
#     echo 'export PATH=$PATH:/root/dev-cheats/' >> ~/.bashrc
